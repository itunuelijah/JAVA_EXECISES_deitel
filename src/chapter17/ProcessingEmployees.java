...
public class ProcessingEmployees {
    public static void main(String[] args) {
        Employee[] employees = {
            ...
            new Employee( "Matthew", "Indigo", 4700.77, "Marketing"),
            new Employee("James", "Indigo", 6200, "IT"),
       ...
       List<Employee> list = Arrays.asList(employees);
        ...
        System.out.printf("%nSum of Employee' salaries (via sum method): %.2f%n",
                list.stream()
                        .mapToDouble(Employee::getSalary)
                        .sum());

        System.out.printf("%nSum of Employee' salaries (via reduced method): %.2f%n",
                list.stream()
                        .mapToDouble(Employee::getSalary)
                        .reduce(0, (value1, value2) -> value1 + value2));


        System.out.printf("Average of Employee' salaries (via reduced method): %.2f%n",
                list.stream()
                        .mapToDouble(Employee::getSalary)
                        .sum());
